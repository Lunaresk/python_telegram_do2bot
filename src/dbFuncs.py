...
def initDB():
  with getCur() as cur:
    cur.execute("CREATE TABLE IF NOT EXISTS Users(TId BIGINT PRIMARY KEY NOT NULL, Lang CHAR(2) NOT NULL DEFAULT 'en');")
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS InSettings(List TEXT NOT NULL REFERENCES Lists(Code), User BIGINT NOT NULL REFERENCES Users(TId));")
    cur.execute("CREATE TABLE IF NOT EXISTS Notify(List TEXT NOT NULL REFERENCES Lists(Code), User BIGINT NOT NULL REFERENCES Users(TId));")
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS PrivateInlines(InlineID TEXT PRIMARY KEY NOT NULL, MessageID BIGINT NOT NULL);")
